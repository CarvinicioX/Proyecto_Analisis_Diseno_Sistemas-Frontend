...
@Component({
  selector: 'modificar_tareas',
  templateUrl: 'modificar_tareas.template.html'
})
...
export class ModificarTareasComponent implements OnInit{
	...
	constructor(form_builder: FormBuilder, private router:Router, private service:MaestroTareasService){
