...
export class AdminClasesComponent implements OnInit{
	...
	do_add(){
		if(	this.add_form.valid && 
		    ...
		    var response;
			this.service.post_clase(load).subscribe(
		        data => response = data,
	...
	open_edit(clase){
    	...
    	this.editar_form.controls['codigo'].setValue(clase.codigo);
    	this.editar_form.controls['nombre'].setValue(clase.nombre);
    }
    ...
    delete_alumno(clase){
    	swal({
		    ...
		    if (result.value) {
		    	var response;
		    	this.service.delete_clase(clase.codigo).subscribe(
			        data => response = data,
    ...
    internalServerError() {
  	...
  	editar_success() {
      	swal({
          	...
          	text: "Clase editada de forma exitosa.",
          	confirmButtonText: '<i class="fa fa-thumbs-up"></i> Genial!',
          	allowOutsideClick: false,
          	type: "success"
      	}).catch(swal.noop)
  	...
  	delete_success() {
      	swal({
          	...
          	text: "Clase eliminada de forma exitosa.",
          	confirmButtonText: '<i class="fa fa-thumbs-up"></i> Genial!',
          	allowOutsideClick: false,
          	type: "success"
      	}).catch(swal.noop)
